          ...
          >
            {[
              ...
              },
              {
                ...
                desc: 'Конструкция дрона рассчитана на транспортировку грузов до 4 кг. Идеально для документов, медикаментов и малогабаритной электроники.',
              },
              {
                icon: Crosshair,
